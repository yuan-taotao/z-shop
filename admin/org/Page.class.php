<?php
	//该对象最后返回 limit的两个参数  越过多少条，取出多少条。
	//该对象中还应该存再一个方法，显示分页效果的方法

	class Page{
		//成员属性
		public $page = 1;//当前页
		public $maxRows = 0;//总条数
		public $pageSize = 0;//每页显示多少条
		public $maxPage = 0;//总页数
		public $url = null;//当前页面URL地址
		...
		public function showPage(){
			$str = '';
			$str .= '当前第'.$this->page.'/'.$this->maxPage.'页 共'.$this->maxRows.'条&nbsp;';
